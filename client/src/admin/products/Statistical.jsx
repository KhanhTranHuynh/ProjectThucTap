...
const Dashboard = () => {
    ...
    const columns = [
        ...
        { title: 'Video Link', dataIndex: 'link_video', key: 'link_video', render: (text) => <a href={`/${text}`} target="_blank" rel="noopener noreferrer">View Video</a> },
        { title: '3D Model Link', dataIndex: 'link_3d', key: 'link_3d', render: (text) => <a href={`/${text}`} target="_blank" rel="noopener noreferrer">Download Model</a> },
        {
            title: 'Create Date',
    ...
    const summaryData = [
        { title: "Models Created Today", value: filteredDay.length, change: "" },
        { title: "Models Created This Year", value: filteredYear.length, change: "" },
        { title: "All Models", value: data.length, change: "" },
    ];
        ...
        <div style={{ padding: "20px", backgroundColor: "#f9f9f9", minHeight: "100vh" }}>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                    <Card>
                        <CardContent>
                            <Typography variant="h6">Models Created in {yearToFilter}</Typography>
                            <BarChart width={1200} height={300} data={barChartData}>
                                <XAxis dataKey="Month" />
                                <YAxis />
                                <Tooltip />
                                <Bar dataKey="Total Model" fill="#8884d8" />
                            </BarChart>
                        </CardContent>
                    </Card>
                </Grid>
